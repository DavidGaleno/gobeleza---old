  ...
  return (
    <div className={styles.container}>
      ...
      <form className={styles.form}>
        ...
        <Select fatherClass={styles.selectInput} onChange={(e) => setModalidade(e.target.value)} label="Selecione a modalidade do cartão" options={['Débito', 'Crédito']} />
        {modalidade === 'Crédito' &&
          <Select fatherClass={styles.selectInput} label="Selecione o número de parcelas" options={['1X', '2X', '4X', '6X', '8X', '10X', '12X']} />
        }
